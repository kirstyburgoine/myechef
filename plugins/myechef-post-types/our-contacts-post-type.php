...
/**
 * Plugin Name: MyEchef - Our Contacts Post Type
 * Description: Creates the contacts post type so that it can be activated / deactivated in sub sites
 * Version: 1.0
...
function kb_register_contacts_post_type() {
	...
	$args = array(
		...
		'public'				=> TRUE,
		'query_var'				=> TRUE,
		'rewrite'				=> array('slug' => 'our-contacts', 'with_front' => FALSE),
	...
	register_post_type('our_contact', $args );

}

add_action( 'init', 'kb_register_contacts_post_type' );



function kb_register_contacts_taxonomies() {
...
add_action( 'init', 'kb_register_contacts_taxonomies' );
	...
	register_field_group(array (
		...
		'fields' => array (
			array (
				...
				'type' => 'radio',
				'instructions' => 'This effects whether the contact will appear at the top of the page and whether the featured image will display.',
				'required' => 1,
				'choices' => array (
					'Yes' => 'Yes',
					'No' => 'No',
