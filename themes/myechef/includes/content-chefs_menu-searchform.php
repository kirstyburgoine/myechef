...
<div id="searchbox">
	...
	<form method="get" id="suppliersearch" action="<?php bloginfo('url'); ?>/supplier-search-results" class="taxonomy-filter">
        
        <div class="grid">

        	<div class="grid__item one-half desk-one-fifth">

        		<label for="c">Type of Supplier:</label>
