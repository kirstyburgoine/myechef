<?php
/* 
 * Default custom post type archive for Information Centre - Basically the same as chefepedia but specifically different to give the option in sub domains
 * Code here should match archive-chefepedia.php and taxonomy-alphabet.php exactly
 */
